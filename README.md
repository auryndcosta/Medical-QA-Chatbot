...
```bash
git clone https://github.com/auryndcosta/Medical-QA-Chatbot.git
```
...
### STEP 4 - AWS-CICD-Deployment-with-Github-Actions
...
![Medical Chatbot Demo](assets/chatbot_demo.png)